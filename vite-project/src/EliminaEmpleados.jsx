...
export const EliminaEmpleados = () => {
    ...
    const onSubmit = async (event) => {
        ...
        console.log(`http://localhost/proyecto2/php/elimiemp.php?id=${id}`);

        try {
            const response = await fetch(`http://localhost/proyecto2/php/elimiemp.php?id=${id}`, {
                method: 'GET', 
                headers: {
