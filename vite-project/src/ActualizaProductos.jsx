...
export const ActualizaProductos = () => {
    ...
    const onSubmit = async (event) => {
        ...
        console.log(`http://localhost/proyecto2/php/actuproductos.php?${parametros}`);

        try {
            const response = await fetch(`http://localhost/proyecto2/php/actuproductos.php?${parametros}`, {
                method: 'GET',
                headers: {
