...
export const ActualizaClientes = () => {
    ...
    const onSubmit = async (event) => {
        ...
        console.log(`http://localhost/proyecto2/php/actuclientes.php?${parametros}`);

        try {
            const response = await fetch(`http://localhost/proyecto2/php/actuclientes.php?${parametros}`, {
                method: 'GET',
                headers: {
