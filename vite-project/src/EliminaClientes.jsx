...
export const EliminaClientes = () => {
    ...
    const onSubmit = async (event) => {
        ...
        console.log(`http://localhost/proyecto2/php/elimicli.php?id=${id}`);

        try {
            const response = await fetch(`http://localhost/proyecto2/php/elimicli.php?id=${id}`, {
                method: 'GET', 
                headers: {
