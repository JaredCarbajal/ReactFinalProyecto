...
export const ActualizaEmpleados = () => {
    ...
    const onSubmit = async (event) => {
        ...
        console.log(`http://localhost/proyecto2/php/actuempleados.php?${parametros}`);

        try {
            const response = await fetch(`http://localhost/proyecto2/php/actuempleados.php?${parametros}`, {
                method: 'GET',
                headers: {
